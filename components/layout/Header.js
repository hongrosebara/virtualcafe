        ...
        <div className='col-span-3 lg:col-span-3 flex items-center'>
          <Link href="/">
            <svg 
              ...
              stroke="currentColor" fill="var(--color-text-primary)" strokeWidth="0" role="img" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><title></title>
              <path 
          ...
          <Link href="/">
            <div className='text-primary'>We Dream Of Coffee</div>
          </Link>
        </div>
