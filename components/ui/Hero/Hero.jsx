...
const Hero = () => {
  ...
  return (
    <section className="relative flex items-center justify-center">
      ...
      /> */}
      <div className="w-full h-[80vh] bg-primary-dk bg-[url('https://res.cloudinary.com/dkv6uc5me/image/upload/v1685071364/hero_image_ka22gw.jpg')] bg-cover bg-center rounded-xl">
        <div className={s["hero-image__overlay"]}>
          <div className={s["hero__text-box"]}>
            ...
            <Link href="/ask-anything-about-coffee/">
              <button className="mt-3 bg-surface hover:bg-surface-dk px-6 py-3 lg:px-10 lg:py-5 rounded-md text-base lg:text-xl text-on-primary shadow-sm">
                Ask Now
              </button>
            </Link>
          </div>
